...
window.DAG_TEXTS["hero.sub"]         = { es: "El dashboard DAG reúne todos los datos de tus vuelos en un solo lugar. Chequeás el estado de cada ganado, comparás con vuelos anteriores y descargás informes sin necesidad de abrir una planilla.", en: "The DAG dashboard brings all your flight data together in one place. Check the state of each cattle, compare with previous flights, and download reports without opening a spreadsheet." };
...
window.DAG_TEXTS["metric.peso.label"]    = { es: "Peso promedio del ganado",      en: "Average cattle weight" };
...
window.DAG_TEXTS["metric.alertas.desc"]  = { es: "Animales que están fuera del rango de condición corporal configurado para este ganado. Se muestran identificados en el video anotado.", en: "Animals outside the configured body condition range for this cattle. Shown identified in the annotated video." };
...
window.DAG_TEXTS["m1.sub"]     = { es: "En la parte superior del dashboard siempre tenés visible: cantidad de cabezas detectadas en el último vuelo, peso promedio del ganado, cantidad de alertas activas y cuántos días hace del último vuelo.", en: "At the top of the dashboard you always see: head count from the last flight, average cattle weight, number of active alerts, and how many days since the last flight." };
...
window.DAG_TEXTS["m1.bullet2"] = { es: "Los KPIs varían por ganado seleccionado. Podés navegar entre todos los ganados del establecimiento.", en: "KPIs vary by selected cattle. You can navigate all cattles on the property." };
...
window.DAG_TEXTS["m2.title"]   = { es: "Gráfico de peso mensual del ganado",    en: "Monthly cattle weight chart" };
window.DAG_TEXTS["m2.sub"]     = { es: "El gráfico de peso mensual muestra cómo evolucionó el peso promedio de cada ganado vuelo a vuelo. Podés detectar caídas de condición antes de que se conviertan en un problema sanitario o productivo.", en: "The monthly weight chart shows how each cattle's average weight evolved flight by flight. You can detect condition drops before they become a health or productivity problem." };
window.DAG_TEXTS["m2.bullet1"] = { es: "Línea de tiempo con todos los vuelos del establecimiento, agrupados por ganado.", en: "Timeline with all property flights, grouped by cattle." };
window.DAG_TEXTS["m2.bullet2"] = { es: "Podés superponer dos ganados distintos para comparar el ritmo de engorde.", en: "You can overlay two different cattles to compare fattening rates." };
window.DAG_TEXTS["m2.bullet3"] = { es: "Anotaciones automáticas en el gráfico cuando ocurrió un cambio de tropilla o una alerta activa.", en: "Automatic annotations on the chart when a cattle change or active alert occurred." };

/* ════════════════════════════════════════════════════════════
   MÓDULO 3 — CONDICIÓN CORPORAL
════════════════════════════════════════════════════════════ */
window.DAG_TEXTS["m3.label"]   = { es: "Condición corporal",                   en: "Body condition" };
window.DAG_TEXTS["m3.title"]   = { es: "Distribución de la tropa de un vistazo", en: "cattle distribution at a glance" };
...
/* ════════════════════════════════════════════════════════════
   MÓDULO 4 — MAPA DE ganadoS
════════════════════════════════════════════════════════════ */
window.DAG_TEXTS["m4.label"]   = { es: "Mapa de ganados",                        en: "cattle map" };
window.DAG_TEXTS["m4.title"]   = { es: "Tu campo dibujado, por ganado y estado", en: "Your property mapped, by cattle and status" };
window.DAG_TEXTS["m4.sub"]     = { es: "El mapa muestra el establecimiento con cada ganado delineado sobre OpenStreetMap. El color del ganado indica si tiene alertas activas (rojo), condición normal (verde) o sin datos recientes (gris).", en: "The map shows the property with each cattle outlined on OpenStreetMap. cattle color indicates active alerts (red), normal condition (green), or no recent data (gray)." };
window.DAG_TEXTS["m4.bullet1"] = { es: "Clic en un ganado abre su panel detallado con métricas del último vuelo.", en: "Clicking a cattle opens its detailed panel with last flight metrics." };
...
window.DAG_TEXTS["m4.bullet3"] = { es: "Gris: el ganado no tiene vuelos en los últimos 30 días.", en: "Gray: the cattle has no flights in the last 30 days." };
...
window.DAG_TEXTS["m5.bullet1"] = { es: "Filtro por ganado, rango de fechas y tipo de alerta para encontrar lo que buscás rápido.", en: "Filter by cattle, date range, and alert type to quickly find what you're looking for." };
...
window.DAG_TEXTS["alerta.warn.desc"]    = { es: "Se activa cuando un animal individual perdió más del umbral de peso configurado entre dos vuelos consecutivos del mismo ganado. El animal queda identificado con su ID en el video anotado.", en: "Triggered when an individual animal lost more than the configured weight threshold between two consecutive flights of the same cattle. The animal is identified by its ID in the annotated video." };
window.DAG_TEXTS["alerta.info1.title"]  = { es: "Información — Cambio de conteo significativo", en: "Info — Significant count change" };
window.DAG_TEXTS["alerta.info1.desc"]   = { es: "Se activa cuando el conteo del último vuelo difiere en más del 5% respecto al vuelo anterior del mismo ganado. Puede indicar movimiento de tropas, fallas de detección o un error de vuelo.", en: "Triggered when the last flight count differs by more than 5% from the previous flight of the same cattle. May indicate cattle movement, detection failure, or flight error." };
window.DAG_TEXTS["alerta.info2.title"]  = { es: "Información — ganado sin vuelo reciente",   en: "Info — cattle without recent flight" };
window.DAG_TEXTS["alerta.info2.desc"]   = { es: "Recordatorio automático cuando un ganado lleva más de 30 días sin ser relevado, para que no pierdas la continuidad del historial.", en: "Automatic reminder when a cattle hasn't been surveyed for more than 30 days, so you don't lose history continuity." };
window.DAG_TEXTS["alerta.config"]       = { es: "Los umbrales de cada alerta son configurables por ganado o por establecimiento. Podés definir que una alerta se dispare a partir del 5%, 10% o cualquier porcentaje de animales en bajo peso que tenga sentido para tu campo.", en: "Each alert threshold is configurable per cattle or per property. You can set alerts to trigger at 5%, 10%, or any percentage of underweight animals that makes sense for your cattle." };
...
window.DAG_TEXTS["acceso.desk.li4"]      = { es: "Gestión completa de ganados y vuelos offline", en: "Full offline cattle and flight management" };
...
window.DAG_TEXTS["cta.title2"]  = { es: "tus propios ganados",                    en: "your own cattles" };
