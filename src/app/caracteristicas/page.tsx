...
const items: FeatureBlockItem[] = [
  {
    ...
    "description": "El motor de detección corre cuadro a cuadro sobre el video. Cada animal detectado es rastreado individualmente, se le asigna un ID único y lo sigue a lo largo de toda la trayectoria del vuelo.",
    "bullets": [
  ...
  },
  {
    ...
    "description": "Cada animal queda clasificado automáticamente en una de cuatro categorías usando análisis estadístico sobre la densidad corporal del ganado. Sin revisión manual, sin subjetividad.",
    "bullets": [
  ...
  },
  {
    ...
    "description": "Cada vuelo procesado genera un informe PDF automático con el resumen ejecutivo: conteo, peso promedio, distribución de condición corporal y alertas del lote. Ideal para compartir con veterinario, contador o comprador.",
    "bullets": [
